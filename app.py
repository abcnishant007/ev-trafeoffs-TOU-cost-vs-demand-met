...
with col1:
    ...
    image_path = f"images/jpg_output/d_-1_no-accidentOffline-cap-1300-runnum-1_weight_{matched_weight}_page1.jpg"
...
with col2:
    ...
    image_path = f"images/jpg_output/d_-1_45-mins-accident-1-capacity-remaining-start-10amOffline-cap-1300-runnum-1_weight_{matched_weight}_page1.jpg"    
    # st.markdown(f"_Image path: `{image_path}`_")
    if os.path.exists(image_path):
        st.image(image_path, use_container_width=True)
    else:
